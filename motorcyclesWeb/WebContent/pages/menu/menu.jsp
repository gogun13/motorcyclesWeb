...
<link href="/motorcyclesWeb/css/style.css" rel="stylesheet" />
                           ...
                           <li class='has-sub'><a href='#'><span>รายละเอียดการขาย</span></a>
                              <ul onclick="lp_ul_click();">
								...
								<li onclick="lp_li_click(event , '0002');">
									<a href="javascript:lp_home('sale_report');">สรุปการขายรถ</a>
								</li>
							  </ul>
                           </li>
                           <li class='has-sub'><a href='#'><span>ข้อมูลลูกค้า</span></a>
                             <ul onclick="lp_ul_click();">
								<li onclick="lp_li_click(event , '0003');">
									<a href="javascript:lp_home('customer_insert');">บันทึกข้อมูลลูกค้า</a>
								</li>
								<li onclick="lp_li_click(event , '0004');">
									<a href="javascript:lp_home('customer_detail');">ค้นหาข้อมูลลูกค้า</a>
								</li>
							  </ul>
                           </li>
